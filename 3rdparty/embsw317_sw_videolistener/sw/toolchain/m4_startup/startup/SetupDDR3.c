...
void ddr3_config_SIUL(uint8_t module)
{
	...
	switch(module)
	{
		...
		case 0:
			...
			{
				SIUL2.MSCR[i].B.DDR_SEL = 0;			/* DDR3 */
				SIUL2.MSCR[i].B.DSE = 7;			/* 34 Ohm Drive Strength */
...
void config_ddr3(uint8_t module)
{
    ...
    //MMDC->MDSCR.R = 0x00448031;		/* Configure MR1: enable DLL, drive strength=40R, AL off, ODT=40R, write levelling off, TDQS=0, Qoff=on */
	...
	case 0:
		...
		MMDC->MPRDDLCTL.R = 0x46464644;	/* Read delay line offsets */
		MMDC->MPWRDLCTL.R = 0x3B333837;	/* Write delay line offsets */
		MMDC->MPDGCTRL0.R = 0x4177016C;	/* Read DQS gating control 0 */
		MMDC->MPDGCTRL1.R = 0x013A0141;	/* Read DQS gating control 1 */
	break;
	case 1:
		MMDC->MDASP.R = 0x0000007F;		/* 1 GB memory */
		MMDC->MPRDDLCTL.R = 0x45474645;	/* Read delay line offsets */
		MMDC->MPWRDLCTL.R = 0x3E333836;	/* Write delay line offsets */
		MMDC->MPDGCTRL0.R = 0x417A0169;	/* Read DQS gating control 0 */
		MMDC->MPDGCTRL1.R = 0x0137013F;	/* Read DQS gating control 1 */
	break;
    }
#endif
#ifdef _VALEVBA_16BIT
    MMDC->MDASP.R = 0x0000005F;		/* 512 MB memory */
    MMDC->MPRDDLCTL.R = 0x48484A46;	/* Read delay line offsets */
    MMDC->MPWRDLCTL.R = 0x33353533;	/* Write delay line offsets */
    MMDC->MPDGCTRL0.R = 0x414F0149;	/* Read DQS gating control 0 */
    MMDC->MPDGCTRL1.R = 0x0156015D;	/* Read DQS gating control 1 */
#endif
