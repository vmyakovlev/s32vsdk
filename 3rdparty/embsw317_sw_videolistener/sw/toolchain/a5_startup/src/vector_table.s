...
curr_el3_sp0_fiq_vector        :     b fiq_handler
curr_el3_sp0_serror_vector     :     b serror_handler
curr_el3_spx_sync_vector       :
    stp x30, x0, [sp, #-16]!
    stp x1, x2, [sp, #-16]!
    stp x3, x4, [sp, #-16]!
    stp x5, x6, [sp, #-16]!
...
curr_el3_spx_fiq_vector        :     b fiq_handler
...
curr_el2_spx_fiq_vector        :     b fiq_handler
...
curr_el1_spx_fiq_vector        :     b fiq_handler
...
#
irq_handler:
    stp x30, x0, [sp, #-16]!      /*  FIQ/vFIQ,       +0x500 */
    stp x1, x2, [sp, #-16]!
    stp x3, x4, [sp, #-16]!
    stp x5, x6, [sp, #-16]!
    stp x7, x8, [sp, #-16]!
    ...
    stp x17, x18, [sp, #-16]!
     ...
     b.ne    END_IRQ_HLDR
     ldr     w2,=0x000003FF
     and     w18,w3,w2        //@; Keep INT_ID in r18
     
     
     lsl     w2,w18,#3      // Interrupts are 64 bit aligned
     ...
     ldr x10,=GIC400_GICC_EOIR
     str x18,[x10]         //@; Update End of Interrupt register with original value from ICCIAR
