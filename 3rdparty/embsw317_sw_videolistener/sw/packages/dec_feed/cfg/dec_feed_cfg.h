/**
  ...
  @file             dec_feed_cfg.h
  @brief            Static configuration of video decoder driver
  @details
...
==================================================================================================*/
/**
* @def      DECFEED_CFG_DECODER_VARIANT
* @brief    The desired decoder variant to be supported. Currently supported options are: DECODER_JPEG,
*           DECODER_H264
* @hideinitializer
*/
#define DECFEED_CFG_DECODER_VARIANT                     DECODER_H264

/**
* @def      DECFEED_CFG_INIT_CHECK
...
/**
* @def      DEC_FEED_CFG_MAX_STREAMS
* @brief    Number of streams being supported by the Decoder Feeding module
* @hideinitializer
*/
