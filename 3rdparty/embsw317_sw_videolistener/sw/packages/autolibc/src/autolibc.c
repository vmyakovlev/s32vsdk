...
/*==============================================================================
                               LOCAL VARIABLES
==============================================================================*/
static uint32_t u32RandVal = 0x12345678U; /* Random value, seed is 0x12345678 */
/*==============================================================================
                               GLOBAL CONSTANTS
==============================================================================*/
...
/*******************************************************************************
* @function_name fsl_abs
****
* @brief Computes absolute (positive) value of u32Number
* @details If the number has minimal possible value (-2147483648), result is
*          undefined.
* @return The absolute value of u32Number
*/
sint32_t fsl_abs (sint32_t s32Number)
{
    sint32_t s32RetVal;
    if( s32Number < 0 )
    {
