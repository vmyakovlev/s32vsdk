...
==================================================================================================*/
/**
* @def      SCORE_CFG_STREAM_TYPE
* @brief    Type of stream to be processed. Supported values are: H264_OVER_AVB, JPEG_OVER_AVB
* @hideinitializer
*/
#define SCORE_CFG_STREAM_TYPE           H264_OVER_AVB

/**
* @def      SCORE_PREPROCESS_H264_STREAM
* @brief    If TRUE then stream preprocessing is engaged to prepare compatible input of the decoder
*           HW. Only valid for H264_OVER_AVB stream type.
* @hideinitializer
*/
...
*/
#define SCORE_CFG_PERMANENT_SOI_SYNC    FALSE
