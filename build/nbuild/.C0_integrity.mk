...
$(C0_APP): $(_C0_APP_OBJS) $(C0_APP_LIBS)
	...
	$(C0_LD) $(C0_LDSCRIPT) $(C0_LDOO) $+ $(C0_LDOPTS) $(ERRORFILT) ; \
	echo "------------------------------------------------------------" ; \
	echo "Integrating into .ael file..." ; \
	$(C0_INT) $(C0_INTOPTS) -intfile $(C0_APP).int -bsp devtree-arm64 $(C0_APP) -o $(C0_APP)_app ; \
	echo "Done..." ; \
	echo "------------------------------------------------------------"
...
$(C0_LIB): $(_C0_LIB_OBJS)
	...
	rm -f $@ ; \
	$(C0_AR) $(C0_AROPTS) -o $(C0_AROO) $^ $(ERRORFILT) ; \
	echo "------------------------------------------------------------"
...
clean::
	$(NBQ)rm -f $(strip $(C0_LIB) $(_C0_LIB_OBJS)) *.dbo *.dba *.ti
...
$(_C0_OBJS): COMPILE.cpp = $(call nbmsg,"$(C0_PROMPT) CX" $@) \
	$(C0_CX) $(C0_CCOPTS) $(C0_CXOPTS) $(_C0_4ALLOPTS)
...
C0_HDEP_FLAGS := -x assembler-with-cpp $(_C0_4ALLOPTS)
C0_HDEP_CC_FLAGS := $(C0_CCOPTS) $(_C0_4ALLOPTS)
C0_HDEP_CX_FLAGS := $(C0_CCOPTS) $(C0_CXOPTS) $(_C0_4ALLOPTS)
